...
PERMISSIONS = UppercaseNamespace([
    ...
    'MARK_INSTALLER', 'MARK_MALWARE', 'REQUEST_EXEMPTION',
    'RESET_BLOCKABLE_STATE', 'RUN_BATCH_JOB', 'UNFLAG', 'VIEW_CONSTANTS',
    'VIEW_ADMIN_CONSOLE', 'VIEW_HOST_IP', 'VIEW_OTHER_BLOCKABLES',
    'VIEW_OTHER_EVENTS', 'VIEW_OTHER_HOSTS', 'VIEW_OTHER_USERS', 'VIEW_RULES',
    'VIEW_VOTES',
])
...
EXEMPTION_STATE.DefineSet(
    'TERMINAL', ['CANCELLED', 'REVOKED', 'EXPIRED', 'DENIED'])
