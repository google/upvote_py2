...
goog.provide('upvote.admin.rules.uvRuleCard');
...
const TEMPLATE_PREFIX =
    upvote.admin.app.constants.STATIC_URL_PREFIX + 'components/rules/';


/** @export {function():!angular.Directive} */
upvote.admin.rules.uvRuleCard =
    buildCardDirective(TEMPLATE_PREFIX + 'rule-card.html');
});  // goog.scope
