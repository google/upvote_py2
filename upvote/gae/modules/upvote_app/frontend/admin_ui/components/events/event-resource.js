...
goog.provide('upvote.admin.events.EventQueryResource');
goog.provide('upvote.admin.events.EventResource');
...
/** @const {string} */
const API_PREFIX = upvote.admin.app.constants.WEB_PREFIX + 'events/';


/** @export {function(!angular.$resource):!angular.Resource} */
upvote.admin.events.EventResource = buildResource(API_PREFIX + ':id');


/** @export {function(!angular.$resource):!angular.Resource} */
upvote.admin.events.EventQueryResource =
    buildQueryResource(API_PREFIX + 'query/:platform/:type');
});  // goog.scope
