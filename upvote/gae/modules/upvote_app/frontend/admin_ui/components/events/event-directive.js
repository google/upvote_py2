...
goog.provide('upvote.admin.events.uvEventCard');
...
const TEMPLATE_PREFIX =
    upvote.admin.app.constants.STATIC_URL_PREFIX + 'components/events/';


/** @export {function():!angular.Directive} */
upvote.admin.events.uvEventCard =
    buildCardDirective(TEMPLATE_PREFIX + 'event-card.html');
});  // goog.scope
