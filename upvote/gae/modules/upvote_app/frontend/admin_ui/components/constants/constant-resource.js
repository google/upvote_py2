...
goog.provide('upvote.admin.constants.ConstantResource');
...
/** @const {string} */
const API_PREFIX = upvote.admin.app.constants.WEB_PREFIX + 'constants/';


/** @export {function(!angular.$resource):!angular.Resource} */
upvote.admin.constants.ConstantResource =
    buildResource(API_PREFIX + ':constant');
});  // goog.scope
