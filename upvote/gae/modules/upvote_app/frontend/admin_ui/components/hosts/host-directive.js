...
goog.provide('upvote.admin.hosts.uvHostCard');
...
const TEMPLATE_PREFIX =
    upvote.admin.app.constants.STATIC_URL_PREFIX + 'components/hosts/';


/** @export {function():!angular.Directive} */
upvote.admin.hosts.uvHostCard =
    buildCardDirective(TEMPLATE_PREFIX + 'host-card.html');
});  // goog.scope
