...
goog.provide('upvote.admin.votes.uvVoteCard');
...
const TEMPLATE_PREFIX =
    upvote.admin.app.constants.STATIC_URL_PREFIX + 'components/votes/';


/** @export {function():!angular.Directive} */
upvote.admin.votes.uvVoteCard =
    buildCardDirective(TEMPLATE_PREFIX + 'vote-card.html');
});  // goog.scope
