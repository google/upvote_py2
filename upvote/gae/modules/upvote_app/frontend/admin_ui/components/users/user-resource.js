...
goog.provide('upvote.admin.users.UserQueryResource');
goog.provide('upvote.admin.users.UserResource');
...
/** @const {string} */
const API_PREFIX = upvote.admin.app.constants.WEB_PREFIX + 'users/';


/** @export {function(!angular.$resource):!angular.Resource} */
upvote.admin.users.UserResource = buildResource(API_PREFIX + ':id', {
  'getSelf': {
    'method': 'GET',
    'params': {'id': null},
  },
...
/** @export {function(!angular.$resource):!angular.Resource} */
upvote.admin.users.UserQueryResource = buildQueryResource(API_PREFIX + 'query');
});  // goog.scope
