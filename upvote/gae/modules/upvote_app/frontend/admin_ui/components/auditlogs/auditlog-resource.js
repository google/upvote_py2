...
goog.provide('upvote.admin.auditlogs.AuditlogQueryResource');
goog.provide('upvote.admin.auditlogs.AuditlogResource');
...
/** @const {string} */
const API_PREFIX = upvote.admin.app.constants.WEB_PREFIX + 'auditlogs/';


/** @export {function(!angular.$resource):!angular.Resource} */
upvote.admin.auditlogs.AuditlogResource = buildResource(API_PREFIX + ':id');


/** @export {function(!angular.$resource):!angular.Resource} */
upvote.admin.auditlogs.AuditlogQueryResource =
    buildQueryResource(API_PREFIX + 'query');
});  // goog.scope
