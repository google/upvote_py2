...
goog.provide('upvote.admin.auditlogs.uvLogCard');
...
const TEMPLATE_PREFIX =
    upvote.admin.app.constants.STATIC_URL_PREFIX + 'components/auditlogs/';


/** @export {function():!angular.Directive} */
upvote.admin.auditlogs.uvLogCard =
    buildCardDirective(TEMPLATE_PREFIX + 'auditlog-card.html');
});  // goog.scope
