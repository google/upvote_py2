...
goog.provide('upvote.virustotal.VirusTotalResource');
...
upvote.virustotal.VirusTotalResource =
    buildResource(upvote.app.constants.WEB_PREFIX + 'check/virustotal/:hash', {
      'check': {
        'method': 'GET',
        'params': {
          'hash': '@hash',
